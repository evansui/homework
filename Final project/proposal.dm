...
Expected problem
1. There may be  problems with light control, not sure Arduino can directly control the color. 
If other modules are needed to control the light,It will be unwise.
